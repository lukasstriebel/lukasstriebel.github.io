    ...
    return (
        <React.Fragment>
            <div className={`backgound`}>
                ...
                <p>I learned programming with Java at the young age of fifteen. Fascinated by the sheer endless possibilties of coding,
...
function Work() {
    return (
        <React.Fragment>
            <div className={`work about-me-item`}>
                ...
                <div className={`work__item`}>
                    ...
                    <p>Having more than 10 years of practical experience with Java, I write most of my backends as <span className={`highlight`}>RESTful API</span>, supported by either the Spring or EJB Framework.
                    </p>
                </div>
                <div className={`work__item`}>
                ...
                <div className={`work__item`}>
                    ...
                    <p>I enjoy teaching junior engineers the importance of well-written code and functional unit tests. It took me a long time to realize
                        that the upfront time investment is always pays dividends in the long run.
                    </p>
                </div>
            </div>
        </React.Fragment>
...
function Passion() {
    return (
        <React.Fragment>
            <div className={`passion about-me-item`}>
                <h3 className={`heading-secondary`}>Code is art</h3>
                <p>The one thing I enjoy more than writing code is actually deleting it.
                    Writing <span className={`highlight`}>Clean Code</span> is an art in itself. Unfortunately, a lack of time and skill often leads to a completely convoluted and unreadable
                    mess (Spaghetti code), making bugs almost impossible to spot. Thus, nothing makes me happier than taking an ugly piece of legacy code and turning it into
